<template>
  ...
  <div class="samplelist-container">
    ...
    <div class="samplelist-filter">
      <el-card body-style="padding:10px;box-shadow:0 7px 14px 0 rgba(59, 65, 94, 0.1), 0 3px 6px 0 rgba(0, 0, 0, 0.07)" shadow="hover">
        <el-form
          ref="filter"
          model="filter"
          label-position="left"
    ...
    <div class="samplelist-gallery">
      <el-card
        body-style="padding:10px;height:100vh;overflow:auto"
        shadow="hover"
      >
...
export default {
  data() {
    return {
      ...
      value3: [100, 1000],
      fit: "cover",
      style: "border-radius:10px;box-shadow: 0 7px 14px 0 rgba(59, 65, 94, 0.1), 0 3px 6px 0 rgba(0, 0, 0, 0.07)",
      urls: [
